...
anno_paths = [line.rstrip() for line in open(os.path.join(BASE_DIR, r'meta\anno_paths.txt'))]
anno_paths = [os.path.join(DATA_PATH, p) for p in anno_paths]

#
output_folder = os.path.join(ROOT_DIR, r'data\stanford_indoor3d')
print(output_folder)
...
for anno_path in anno_paths:
    ...
    try:
        ...
        out_filename = tmp[-3]+'_'+tmp[-2]+'.npy' # Area_1_hallway_1.npy
