...
|--|--|--|--|
| PointNet (Pytorch) | 78.9 | 43.7| [40.7MB](data_utils/log/sem_seg/pointnet_sem_seg) |
| PointNet2_ssg (Pytorch) | **83.0** | **53.5**| [11.2MB](data_utils/log/sem_seg/pointnet2_sem_seg) |
